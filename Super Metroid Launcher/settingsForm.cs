...
namespace Super_Metroid_Launcher
{
    public partial class settingsForm : Form
    {
        ...
        private void buttonReset_Click(object sender, EventArgs e)
        {
            ...
            {
                answer = MessageBox.Show("INI backup file is corrupted and preventing the settings menu from loading.\n\nDo you want to download a clean copy from the sm repository?", "Corrupted Settings", MessageBoxButtons.YesNo);
                ...
                File.Delete(Path.Combine(Program.repoDir, "backup", "sm.ini"));
        ...
        {
            var filename = "sm.ini";
            Uri uri = new Uri("https://raw.githubusercontent.com/snesrev/sm/master/sm.ini");

            var directory = Path.Combine(Program.repoDir, "backup");
            var destination = Path.Combine(Program.repoDir, "backup", filename);
        ...
        private void ImportINI()
        {
            ...
            if (!File.Exists(iniFile))
            {
                ...
                MainForm.CopyFromBackupINI(iniFile, iniBackup);
            }
        ...
        {
            // Build INI data structure from existing sm.ini file
            var iniFile = Path.Combine(Program.repoDir, "sm.ini");
            var iniText = File.ReadAllText(iniFile);
        ...
        private void linkLabelCustomSprites_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            Process.Start(new ProcessStartInfo("https://snesrev.github.io/sprites-gfx/snes/sm/link/") { UseShellExecute = true });
            */
        }
        ...
        private void linkLabelMinorFixes_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            Process.Start(new ProcessStartInfo("https://github.com/snesrev/sm/wiki/Bug-Fixes-:-Misc.") { UseShellExecute = true });
            */
        }
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            Process.Start(new ProcessStartInfo("https://github.com/snesrev/sm/wiki/Bug-Fixes-:-Game-Changing") { UseShellExecute = true });
            */
        }
    }
}
